...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private final TwitterKafkaStatusListener twitterStatusListener;
    private static final Random RANDOM = new Random();
    private static final String[] WORDS = new String[]{
            "Generate", "fake", "United States", "address", "complete with street", "city", "state", "zip", "codes"
    };
    ...
    public MockKafkaStreamRunner(TwitterToKafkaServiceConfigData twitterToKafkaServiceConfigData, TwitterKafkaStatusListener twitterStatusListener) {
    ...
    public void start() throws TwitterException {
        ...
        LOG.info("started mock filtering twitter stream {}", Arrays.toString(
                keywords));
        SimulateTweeterStream(keywords, minTweetLength, maxTweetLength, sleepTimeMs);
    }

    private void SimulateTweeterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs){
        Executors.newSingleThreadExecutor().submit(() -> {
           try{
               ...
               LOG.error("Error in creating tweeter status!", e);
           }
        });
